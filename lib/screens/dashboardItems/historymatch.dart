...
class HistoryMyMatches extends StatefulWidget {
  final int fragmentToShow;
  String pendingamount;
  String nopaycount;
  HistoryMyMatches({Key? key, required this.fragmentToShow,required this.pendingamount,required this.nopaycount}) : super(key: key);

  @override
  State<HistoryMyMatches> createState() => _HistoryMyMatchesState();
}

class _HistoryMyMatchesState extends State<HistoryMyMatches> with LoadMoreListener , SingleTickerProviderStateMixin {
