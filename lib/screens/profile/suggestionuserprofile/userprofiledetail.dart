...
import 'package:oo/screens/profile/suggestionuserprofile/userfollow.dart';
import 'package:oo/screens/profile/suggestionuserprofile/userfollowing.dart';

class UserProfileDetailsScreen extends StatefulWidget {
  final int fragmentToShow;
  int id;

  UserProfileDetailsScreen({Key? key, required this.fragmentToShow,required this.UserName,required this.followerscount,
    required this.followingcount,required this.id}) : super(key: key);
...
class _UserProfileDetailsScreenState extends State<UserProfileDetailsScreen> with LoadMoreListener , SingleTickerProviderStateMixin {
  ...
  getSubFragment(int pos) {
    switch (pos) {
      case 0:
        return UserFollowScreen(id:widget.id);
        break;
      case 1:
        return UserFollowingScreen(id:widget.id);
        break;
