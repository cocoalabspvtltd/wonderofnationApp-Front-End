...
import '../../apis/repositories/levelling_register.dart';
...
class _LevelingsecondState extends State<Levelingsecond> {
  @override
  LevellingRegisterRepository LevellingRedisteapi =
      LevellingRegisterRepository();
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Column(children: [
            ...
            Text(
              "You can start playing matches in wonder of nation",
